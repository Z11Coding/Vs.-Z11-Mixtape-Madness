...
class NoteSplash extends NoteObject
{
	...
	public function new(x:Float = 0, y:Float = 0, ?note:Int = 0) {
		...
		var skin:String = 'noteskins/noteSplashes';
		if(PlayState.SONG.splashSkin != null && PlayState.SONG.splashSkin.length > 0) skin = 'noteskins/'+PlayState.SONG.splashSkin;
	...
	public function setupNoteSplash(x:Float, y:Float, note:Int = 0, texture:String = null, hueColor:Float = 0, satColor:Float = 0, brtColor:Float = 0) {
		...
		if(texture == null) {
			texture = 'noteskins/noteSplashes';
			if(PlayState.SONG.splashSkin != null && PlayState.SONG.splashSkin.length > 0) texture = 'noteskins/'+PlayState.SONG.splashSkin;
		}
