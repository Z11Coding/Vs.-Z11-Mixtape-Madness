...
class NotiPopup extends openfl.display.Sprite {
    ...
    @:allow(objects.NotiPopup)
	private static var _popups:Array<NotiPopup> = [];
    ...
    public static function startPopup(massage:String, desc:String, image:String, ?endFunc:Void->Void = null) {
		...
		var newPop:NotiPopup = new NotiPopup(massage, desc, null, image, endFunc);
		_popups.push(newPop);
	}
}