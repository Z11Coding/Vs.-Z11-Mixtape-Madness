...
class FunkinPreloader extends FlxBasePreloader
{
  ...
  public function new()
  {
    ...
    this.siteLockTitleText = "Stop Being Lazy!";
    this.siteLockBodyText = "This isn't an exe!\nGo play Z11's Mixtape Mayhem on Gamebanana:";
  }
  ...
  override function create():Void
  {
    ...
    for (i in 0...amountOfPieces)
    {
      ...
      piece.graphics.beginFill(0xFF7811FF);
    ...
    // progressBar = new Bitmap(new BitmapData(1, BAR_HEIGHT, true, 0xFF7811FF));
    ...
    var progressLeftTextFormat = new TextFormat("DS-Digital", 32, 0xFF7811FF, true);
    ...
    var progressRightTextFormat = new TextFormat("DS-Digital", 16, 0xFF7811FF, true);
    ...
    enhancedText.textColor = 0xFF7811FF;
    ...
    stereoText.textColor = 0xFF7811FF;
  ...
  function updateProgressLeftText(text:Null<String>):Void
  {
    if (progressLeftText != null)
    {
      ...
      else if (progressLeftText.text != text)
      {
        ...
        enhancedText.defaultTextFormat = new TextFormat("Inconsolata Black", 16, 0xFF7811FF, false);
        enhancedText.text = 'ENHANCED';
        enhancedText.textColor = 0xFF7811FF;

        stereoText.defaultTextFormat = new TextFormat("Inconsolata Bold", 36, 0xFF7811FF, false);
