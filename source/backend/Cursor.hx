...
class Cursor
{
  ...
  public static final CURSOR_DEFAULT_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-default.png",
      scale: 1.0,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_CROSS_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-cross.png",
      scale: 0.5,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_ERASER_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-eraser.png",
      scale: 1.0,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_GRABBING_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-grabbing.png",
      scale: 1.0,
      offsetX: -8,
      offsetY: 0,
    };
  ...
  public static final CURSOR_HOURGLASS_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-hourglass.png",
      scale: 1.0,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_POINTER_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-pointer.png",
      scale: 1.0,
      offsetX: -8,
      offsetY: 0,
    };
  ...
  public static final CURSOR_TEXT_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-text.png",
      scale: 0.2,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_TEXT_VERTICAL_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-text-vertical.png",
      scale: 0.2,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_ZOOM_IN_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-zoom-in.png",
      scale: 1.0,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_ZOOM_OUT_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-zoom-out.png",
      scale: 1.0,
      offsetX: 0,
      offsetY: 0,
    };
  ...
  public static final CURSOR_CROSSHAIR_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-crosshair.png",
      scale: 1.0,
      offsetX: -16,
      offsetY: -16,
    };
  ...
  public static final CURSOR_CELL_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-cell.png",
      scale: 1.0,
      offsetX: -16,
      offsetY: -16,
    };
  ...
  public static final CURSOR_SCROLL_PARAMS:CursorParams =
    {
      graphic: "assets/shared/images/cursor/cursor-scroll.png",
      scale: 0.2,
      offsetX: -15,
      offsetY: -15,
    };
