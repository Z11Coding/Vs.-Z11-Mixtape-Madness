...
class ClientPrefs {
	...
	{
		FlxG.sound.muteKeys = turnOn ? FirstCheckState.muteKeys : [];
		FlxG.sound.volumeDownKeys = turnOn ? FirstCheckState.volumeDownKeys : [];
		FlxG.sound.volumeUpKeys = turnOn ? FirstCheckState.volumeUpKeys : [];
	}
}
