...
class DynamicIterator {
	...
	public static function iteratorToArray(iterator:Iterator<Any>):Array<Dynamic> {
		var array = [];
	...
	//iteratorToArrayAlias
	public static function toArray(iterator:Iterator<Any>):Array<Dynamic> {
