...
class Paths
{
	...
	[
		...
		'assets/shared/music/celebration.$SOUND_EXT',
		'assets/shared/music/Drippy-Genesis.$SOUND_EXT',
		'assets/shared/music/False-Memory.$SOUND_EXT',
		'assets/shared/music/Funky-Genesis.$SOUND_EXT',
		'assets/shared/music/Reglitch.$SOUND_EXT',
		'assets/shared/shared/music/breakfast.$SOUND_EXT',
		'assets/shared/shared/music/tea-time.$SOUND_EXT',
		'assets/shared/shared/music/late-night-cafe.$SOUND_EXT',
		'assets/shared/shared/music/late-night-cafe-resist.$SOUND_EXT',
	];
	...
	inline static public function getMusic(key:String, ?library:String):Any
	{
		var file = returnSound('music', key, library);
		return file;
	}
	...
	static public function getSound(key:String, ?library:String):Any
	{
    ...
    inline static public function file2(key:String, location:String, extension:String):String{
	...
	inline static public function cacheSound(key:String){
        return file2(key, "sounds", audioExtension);
    }

	inline static public function cacheMusic(key:String){
        return file2(key, "music", audioExtension);
    }
