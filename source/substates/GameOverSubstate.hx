...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		{
			boyfriend = new Character(PlayState.instance.boyfriend.getScreenPosition().x, PlayState.instance.boyfriend.getScreenPosition().y, 'bf-dead', true);
			boyfriend.x += boyfriend.positionArray[0] - PlayState.instance.boyfriend.positionArray[0];
			boyfriend.y += boyfriend.positionArray[1] - PlayState.instance.boyfriend.positionArray[1];
			add(boyfriend);
		}
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			if (PlayState.isStoryMode)
				TransitionState.transitionState(StoryMenuState, {transitionType: "stickers"});
			else
