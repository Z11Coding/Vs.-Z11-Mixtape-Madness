...
class StoryMenuState extends MusicBeatState
{
	...
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('Main_Checker'+FlxG.random.int(0,1)), XY, Std.int(0.2), Std.int(0.2));
	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			if(!isLocked || !weekFile.hiddenUntilUnlocked)
			{
				...
				var weekThing:MenuItem = new MenuItem(900, bgSprite.y + 396, WeekData.weeksList[i]);
				//weekThing.y += ((weekThing.height + 20) * num);
				//weekThing.x += ((weekThing.width + 20) * num);
				weekThing.ID = num;
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x - 500, grpWeekText.members[0].y + 180);
