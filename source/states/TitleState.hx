...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		// var checkUpdateEvent = new EventFunc("CheckUpdate", Change, Type.getClass(FlxG.state).tracker().createVariable(), function() { trace(HoldableVariable.createVariable(update(0))); }, false);
