...
class DialogueEditorState extends MusicBeatState
{
	...
	var skipCheckbox:FlxUICheckBox;
	function addDialogueLineUI() {
		...
		skipCheckbox = new FlxUICheckBox(angryCheckbox.x - 10, speedStepper.y - 20, null, null, "Auto-Skip When Finished", 200);
		skipCheckbox.callback = function()
		{
			updateTextBox();
