...
function onCreatePost()
    ...
    makeShader('BarrelBlurEffect2', {'game', 'hud'})
    makeShader('MirrorRepeatEffect2', {'game', 'hud'})
    makeShader('BloomEffect2', {'game', 'hud'})
    ...
    makeShader('ScanlineEffect2', {'game', 'hud'})
    makeShader('VignetteEffect2', {'game', 'hud'})
    ...
    makeControl('BarrelBlurEffect2','barrel', 0.0)
    makeControl('BarrelBlurEffect2','effect', 0.0)
    makeControl('BarrelBlurEffect2','zoom', 1.0)
    makeControl('BarrelBlurEffect2', 'doChroma', false)

    makeControl('BloomEffect2','strength',0.0)
    makeControl('BloomEffect2','effect',0.0)
    makeControl('BloomEffect2','contrast',0.0)
    makeControl('BloomEffect2','brightness',0.0)

    makeControl('ChromAbEffect','strength',0)

    makeControl('GreyscaleEffect','strength',0)

    makeControl('MirrorRepeatEffect2','x',0.0)
    makeControl('MirrorRepeatEffect2','y',0.0)
    makeControl('MirrorRepeatEffect2','angle',0.0)
    makeControl('MirrorRepeatEffect2','zoom', 1.0)

    makeControl('MosaicEffect','strength',0)

    makeControl('ScanlineEffect2','strength',0.0)
    makeControl('ScanlineEffect2','pixelsBetweenEachLine',10)
    makeControl('ScanlineEffect2','lineHeight',0.6)

    makeControl('VignetteEffect2','size',0)
    makeControl('VignetteEffect2','stretch',0)
    makeControl('VignetteEffect2','red',0)
    makeControl('VignetteEffect2','green',0)
    makeControl('VignetteEffect2','blue',0)
