...
function opponentNoteHit(a,b,c)
    if difficultyName == 'Nightmare' and curStep >= 1024 and curStep <= 1536 then
        if currentBarPorcent < 1 then
            currentBarPorcent = currentBarPorcent + 0.0090
        end
    end
    if difficultyName == 'Nightmare' and curStep <= 2048 and curStep >= 2034 then
        if currentBarPorcent < 1 then
...
function onBeatHit()
    if difficultyName == 'Nightmare' and curStep >= 1024 and curStep <= 1536 or curStep <= 2048 and curStep >= 2034 then
        if currentBarPorcent < 1 then
