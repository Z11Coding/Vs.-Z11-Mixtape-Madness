...
function onCreatePost()
    ...
    if not isPixel then 
    makeAnimatedLuaSprite('strumring', 'stages/personel/ring', ringpos[1], ringpos[2]);
    else
    makeAnimatedLuaSprite('strumring', 'stages/personel/pixelUI/ring', ringpos[1], ringpos[2]);
    end
...
function makeyStuff()
    ...
    if not downscroll then
        makeLuaSprite('counter', 'stages/personel/Counter', 1120, 610);
        else
        makeLuaSprite('counter', 'stages/personel/Counter', 1120, 10);
    end
