...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	MusicianName1 = 'Z11Gaming'
	MusicianName2 = ''
	MusicianName3 = ''

	CharterName1 = 'Z11Gaming'
	CharterName2 = ''
	CharterName3 = '' 
...
Start = 32 --choose which "STEP" to activate the script on
...
function onCreate()
	...
	--CODER 4
	makeLuaText('CODER4', CoderName4, 1280, HorizontalWordsOffset, -1000)
	setTextAlignment('CODER4', 'center')
	setTextSize('CODER4', 25)
	setObjectCamera('CODER4', 'other')
	addLuaText('CODER4')
	setTextFont('CODER4', Font)
	...
	--ARTIST 4
	makeLuaText('ARTIST4', ArtistName4, 1280, HorizontalWordsOffset, -1000)
	setTextAlignment('ARTIST4', 'center')
	setTextSize('ARTIST4', 25)
	setObjectCamera('ARTIST4', 'other')
	addLuaText('ARTIST4')
	setTextFont('ARTIST4', Font)	
