...
function setCamZoom(value)
	setProperty("camGame.zoom", getProperty("camGame.zoom")+(value-0.2))
end
function setHudZoom(value)
	setProperty("camHUD.zoom", getProperty("camHUD.zoom")+(value-0.9))
end