...
function goodNoteHit(a,b,c)
    if currentBarPorcent > 0 then
        if not dadName == 'mio' then
            currentBarPorcent = currentBarPorcent - 0.0110
        else if dadName == 'mio' then
            currentBarPorcent = currentBarPorcent - (0.0110/2)
        else
    ...
    if c == 'Scream Note' then
        if not dadName == 'mio' then
            currentBarPorcent = currentBarPorcent - 0.04
        else
            currentBarPorcent = currentBarPorcent - 0.02
        end
    end
end
