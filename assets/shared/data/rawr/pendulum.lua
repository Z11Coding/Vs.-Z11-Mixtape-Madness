...
function onCreatePost()
	-- end of "create"
	makeAnimatedLuaSprite('pendelum', 'mechanics/general/Pendelum_Phase2', 0, 0);
	...
	makeAnimatedLuaSprite('tranceThing', 'mechanics/general/StaticHypno', 0, 0);
...
function win()
	...
	makeAnimatedLuaSprite(shadName, 'mechanics/general/Pendelum_Phase2', xpos, ypos);
