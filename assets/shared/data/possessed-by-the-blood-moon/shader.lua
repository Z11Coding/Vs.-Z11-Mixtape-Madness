...
function loadShader(lua,shader)
    ...
    elseif shader == 'CameraGlitch' then
        setShaderBool(lua,'vignetteOn',false)
        setShaderBool(lua,'perspectiveOn',false)
        setShaderBool(lua,'distortionOn',false)
        setShaderBool(lua,'scanlinesOn',false)
        setShaderBool(lua,'vignetteMoving',false)
        setShaderFloat(lua,'glitchModifier',0)
    end
end
