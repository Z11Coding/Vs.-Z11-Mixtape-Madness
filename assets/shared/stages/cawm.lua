...
function onCreate()
  ...
  makeLuaSprite('back','images/back',0,0)
  scaleObject('back',1.5,1.5)
  addLuaSprite('back',false)
  setProperty('back.alpha',0)

  makeAnimatedLuaSprite('ning','images/Lighting',-550,-400)
